...
{
	Editor *e = qobject_cast<Editor*>(p);
...
*/
void QPanel::editorChange(Editor *)
{
...
/*!
	\internal
*/
bool QPanel::paint(QPainter *, Editor *)
{
	/*
	qWarning("Bad panel implementation : "
			"QPanel::paint(QPainter*, Editor*)"
