...
/*!
	...
	<li>It can only layout widgets in the viewport margins of a Editor (could work with
...
/*!
	\brief ctor
*/
QPanelLayout::QPanelLayout(Editor *p)
...
*/
QPanelLayout::QPanelLayout(const QString& layout, Editor *p)
 : QLayout(p), m_parent(p)
{
	setSpacing(0);
